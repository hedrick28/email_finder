...
import { deliverOrder, getSellerOrders } from "../../services/order";
...
const Orders = () => {
  ...
  const handleOrderDetails = (id) => {
    navigate("/order/orders/details/" + id);
  };
  if (orders) {
    return (
                      ...
                      <tr className="text-center" key={idx}>
                        <td>
                          <div className="table-f-data">
                            <span className="text-capitalize f-s">
                          ...
                          <div className="table-f-data">
                            <Dropdown>
                              ...
                              <Dropdown.Menu>
                                ...
                                <Dropdown.Item
                                  onClick={() =>
                                    handleDeliver(order.order_id, "Canceled")
                                  }
                                  disabled={
                                    order.status === "Canceled" ||
                                    order.status === "Delivered"
                                ...
                                <Dropdown.Item
                                  onClick={() =>
                                    handleDeliver(order.order_id, "Shipped")
                                  }
                                  disabled={
                                    order.status === "Shipped" ||
                                    order.status === "Delivered"
                                ...
                                <Dropdown.Item
                                  onClick={() =>
                                    handleDeliver(order.order_id, "Pending")
                                  }
                                  disabled={
